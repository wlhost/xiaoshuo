...
class Page extends Paginator
{
    ...
    protected function prev()
    {
        if ($this->currentPage() > 1) {
            return "<li class='prev'><a href='" . $this->url($this->currentPage - 1) . "'> « </a></li>";
        } else {
            //return "<li class='prev'><a href='#'>上一页</a></li>";
        }
    }
    ...
    {
        if ($this->hasMore) {
            return "<li class='next'><a href='" . $this->url($this->currentPage + 1) . "'> » </a></li>";
        } else {
            //return "<li class='next'><a href='#'>下一页</a></li>";
        }
    }
    ...
    {
        return '<li class="selected"><a href="">' . $text . '</a></li>';
    }
